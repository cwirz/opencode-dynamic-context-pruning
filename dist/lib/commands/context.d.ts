...
export declare function analyzeContextTokens(state: SessionState, messages: WithParts[]): TokenBreakdown;
export declare function formatContextMessage(breakdown: TokenBreakdown): string;
